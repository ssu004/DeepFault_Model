...
if __name__ == "__main__":
    ...
    exp_name = f"{data_name}_{model_name}_{optimizer_name}_{batch_size}_{float(args.lr)}[{exps[0]}-{exps[1]}]"
    ...
    # seedss = [13, 24, 36, 546, 234, 4789, 342, 1567, 237, 59, 2357, 89, 1798, 356, 603, 5807]
    ...
    for i in exp_idx:
        ...
        if optimizer_name == "sgd":
            optimizer = experiment.get_optimizer(optimizer_name)(model.parameters(), lr=float(args.lr))
        elif optimizer_name == "momentum":
            optimizer = experiment.get_optimizer(optimizer_name)(model.parameters(), lr=float(args.lr), momentum=0.9)
        else:
            optimizer = experiment.get_optimizer(optimizer_name)(model.parameters())
